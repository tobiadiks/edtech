            ...
            <div className="w-full font-inter min-h-screen  lg:mt-16 mt-28 flex flex-col px-4 md:px-4 lg:px-8">
                <div className="flex flex-col mt-4 lg:flex-row">
                    <div className="lg:w-1/2 w-full lg:pr-8">
                        ...
                        <div>
                            ...
                            <div className="my-4 flex">
                                <div className="flex mr-4">
                                    <div className="h-4 my-auto w-4 mr-2 rounded-full bg-emerald-100"></div>
                                    <div>4.7 (23 Rating)</div>
                                </div>
                                <div className="font-semibold text-emerald-400">Read Bio</div>
                            </div>

                            <div className="my-4 flex">
                                <div className="flex mr-4 border hover:border-emerald-200 border-emerald-100 rounded-full p-2">
                                    <div className="h-8 my-auto w-8 mr-2 rounded-full bg-emerald-100"></div>
                        ...
                        <div className="p-4 my-8 relative overflow-hidden border rounded-md border-emerald-100">
                            <div className="absolute top-0 left-0 w-8 h-full  blur-3xl bg-emerald-200"></div>
                            <div className=" border-b-2 py-4 my-8 border-b-emerald-100">
                            ...
                            <div className="my-8">
                                ...
                                <div className="mt-4 flex flex-wrap  gap-4">
                                    <div className="font-semibold bg-emerald-50 p-2 rounded-full">UX Research</div>
                                    <div className="font-semibold bg-emerald-50 p-2 rounded-full">UX Design</div>
                                    <div className="font-semibold bg-emerald-50 p-2 rounded-full">Information Architecture</div>
                                    <div className="font-semibold bg-emerald-50 p-2 rounded-full">Iconography</div>
                                    <div className="font-semibold bg-emerald-50 p-2 rounded-full">UX Copywriting</div>                            </div>
                            </div>
                        </div>
