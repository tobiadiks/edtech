        ...
        <div >
            <div className="bg-white rounded-xl font-inter  flex flex-col justify-between p-2 mx-0 ">
                <div className="w-full  flex flex-row justify-between">
                    ...
                    <div className="text-xs my-auto text-emerald-400 cursor-pointer">Change Track</div>
                </div>
                <div className="mt-2 w-full flex flex-col ">
                    ...
                    <div className=" text-sm  my-auto">
                        <div className="flex justify-between my-2">
                            ...
                            <div className="h-3 flex  rounded-lg bg-emerald-50 mr-2 my-auto w-1/4">
                                <div className="h-full w-[100%] rounded-lg bg-emerald-600"></div>
                        ...
                        <div className="flex justify-between my-2">
                            ...
                            <div className="h-3 flex  rounded-lg bg-emerald-50 mr-2 my-auto w-1/4">
                                <div className="h-full w-[0%] rounded-l-lg bg-emerald-600"></div>
                        ...
                        <div className={cn("md:flex justify-between my-2 ", isExpand ? 'flex' : 'hidden')}>
                            ...
                            <div className="h-3 flex  rounded-lg bg-emerald-50 mr-2 my-auto w-1/4">
                                <div className="h-full w-[85%] rounded-l-lg bg-emerald-600"></div>
                                <div className="h-full w-1  bg-black"></div>
                            </div>
                        </div>
                        ...
                        <div className={cn("md:flex justify-between my-2 ", isExpand ? 'flex' : 'hidden')}>
                            ...
                            <div className="h-3 flex  rounded-lg bg-emerald-50 mr-2 my-auto w-1/4">
                                <div className="h-full w-[50%] rounded-l-lg bg-emerald-600"></div>
                                <div className="h-full w-1  bg-black"></div>
                            </div>
                        </div>
                        <div className="text-center text-xs md:hidden cursor-pointer text-emerald-400" onClick={() => { setIsExpand(!isExpand) }}>{isExpand ? 'close' : 'expand'}</div>
                    </div>
                </div>
