...
const RecommendedPathCard = (props: {
    ...
    return (
        <div className="shadow bg-white  py-4 px-4 border border-emerald-400 rounded-lg">
            ...
            <div className="flex my-2 ">
                ...
                <div className="text-xs flex ml-4">
                    <div className="rounded-full mr-1 h-6 w-6 bg-emerald-200"></div>
                    <div className="w-fit">
                        <div className="font-semibold">Certificate</div>
                        <div className="text-emerald-400">Available on completion</div>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div className="text-sm my-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum quis earum eum dolorum aliquid quasi deserunt, neque ulla...<span onClick={props.route} className="text-emerald-400 cursor-pointer">Read more</span></div>
            </div>
